...
- (void)backMethod {
    ...
    self.block(self.channelView.dataArray);
}
...
//    self.block = block;
//    self.channelView.dataArray = []
//    self.channelView.da = [NSMutableArray arrayWithArray:enabledTitles];
...
//    self.channelView.disabledTitles = [NSMutableArray arrayWithArray:disabledTitles];
    self.channelView.dataArray = dataArray;
    [self.channelView reloadData];
