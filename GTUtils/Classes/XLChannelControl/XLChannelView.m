...
{
    int num  = (int)[self.dataArray[section] count];
    return num;
}
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        headerView.title = itemDic[@"title"];
        headerView.subTitle = @"";
    }
    return headerView;
}
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        NSMutableArray *topArray = self.dataArray[indexPath.section];
        
        id obj = [topArray objectAtIndex:indexPath.row];
        [topArray removeObjectAtIndex:indexPath.row];
        
        NSDictionary *dic = obj;
        int typeId = [dic[@"typeId"] intValue];
        NSMutableArray *bottomArray = self.dataArray[typeId];
        [bottomArray insertObject:obj atIndex:0];
        ...
        NSMutableArray *bottomArray = self.dataArray[0];
        [bottomArray addObject:dic];
...
//        [self.enabledTitles addObject:obj];
        [self.collectionView moveItemAtIndexPath:indexPath toIndexPath:[NSIndexPath indexPathForRow:bottomArray.count - 1 inSection:0]];
    }
}
...
{
    NSMutableArray *topArray = self.dataArray[0];

    id obj = [topArray objectAtIndex:self.dragingIndexPath.row];
    [topArray removeObject:obj];
    [topArray insertObject:obj atIndex:self.targetIndexPath.row];
}
